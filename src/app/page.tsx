...
export default function Home() {
  ...
  const calculateTime = useCallback(() => {
    ...
    // Cross-browser date parsing: replace dashes with slashes and T with space
  ...
  return (
    <div style={containerStyle}>
      {/* NAVBAR REMOVED FROM HERE TO PREVENT DOUBLE HEADER ERROR */}
        ...
        <div style={{...heroBannerStyle, backgroundImage: `url(${heroEvent.image_url})`}}>
          ...
          <div style={bannerContent}>
            ...
            <div style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
              ...
              <button style={heroBuyBtn} onClick={() => {setSelectedEvent(heroEvent); setIsModalOpen(true);}}>
          ...
          {upcomingEvents.map((event) => (
            <div key={event.id} style={{...cardStyle, backgroundImage: `url(${event.image_url})`}}>
              <div style={cardContent}>
                ...
                <button style={cardBuyBtn} onClick={() => {setSelectedEvent(event); setIsModalOpen(true);}}>
